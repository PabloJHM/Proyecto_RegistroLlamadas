...
public class Tab2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        lista=sd.sacaEntrantesList();
        Cursor cu=sd.sacaSalientesCursor();
    ...
    public int[] obtieneDatosSalientes(){
        int b[],l=0,m=0,x=0,j=0,v=0,s=0,d=0;
        String fecha;
        Cursor cu=getContext().getContentResolver().query(Tablas.TablaLlamadasSalientes.CONTENT_URI, null, null, null, null, null);
        while(cu.moveToNext()){
