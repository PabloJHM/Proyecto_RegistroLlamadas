...
public class Tab1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Cursor cu=sd.sacaEntrantesCursor();
    ...
    public int[] obtieneDatosEntrantes(){
        int b[],l=0,m=0,x=0,j=0,v=0,s=0,d=0;
        String fecha;
        Cursor cu=getContext().getContentResolver().query(Tablas.TablaLlamadasEntrantes.CONTENT_URI,null,null,null,null,null);
        while(cu.moveToNext()){
